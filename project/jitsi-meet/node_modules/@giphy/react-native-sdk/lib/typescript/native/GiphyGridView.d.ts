...
export type NativeGiphyGridViewProps = ViewProps & {
    ...
    onContentUpdate?: (e: NativeSyntheticEvent<{
        resultCount: number;
    }>) => void;
    onMediaSelect?: (e: NativeSyntheticEvent<{
        media: GiphyMedia;
    }>) => void;
    onScroll?: (e: NativeSyntheticEvent<{
        offset: number;
    }>) => void;
...
export declare const NativeGiphyGridView: import("react-native").HostComponent<NativeGiphyGridViewProps>;
//# sourceMappingURL=GiphyGridView.d.ts.map