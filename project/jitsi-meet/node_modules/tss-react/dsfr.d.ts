...
export declare const makeStyles: <Params = void, RuleNameSubsetReferencableInNestedSelectors extends string = never>(params?: {
...
} | undefined) => <RuleName extends string>(cssObjectByRuleNameOrGetCssObjectByRuleName: Record<RuleName, import("./types").CSSObject> | ((theme: import("@codegouvfr/react-dsfr").ColorTheme, params: Params, classes: Record<RuleNameSubsetReferencableInNestedSelectors, string>) => Record<RuleNameSubsetReferencableInNestedSelectors | RuleName, import("./types").CSSObject>)) => (params: Params, styleOverrides?: {
    props: {
    ...
    theme: import("@codegouvfr/react-dsfr").ColorTheme;
...
}) | ((theme: import("@codegouvfr/react-dsfr").ColorTheme, props: Props, classes: Record<Exclude<keyof CssObjectByRuleName, `@media${string}`>, string>) => CssObjectByRuleName), params?: {
    name?: string | Record<string, unknown> | undefined;
    uniqId?: string | undefined;
