        ...
        @if (count($options))
            @foreach ($options as $option)
                @if($current_value == $option->getKey())
                    <option value="{{ $option->getKey() }}" selected>{{ Carbon\Carbon::createFromTimestamp($option->{$field['attribute']})->toDateTimeString() }}</option>
                @else
                    <option value="{{ $option->getKey() }}">{{ Carbon\Carbon::createFromTimestamp($option->{$field['attribute']})->toDateTimeString() }}</option>
                @endif
            @endforeach
        @endif
    </select>
